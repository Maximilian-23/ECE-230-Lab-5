...
## Lab Summary
In this lab we had to code the top.v file, as well as modules a and b from scratch. We also had to modify the constraints file to only map the pins and leds to what we needed for the top and module files. We built module a to route into module b as an input, which then gaave us the final output of the circuit. It was interesting and a good experience to have to build most of the files we used from scratch and gave us a better understanding of how to write code in Verilog.
